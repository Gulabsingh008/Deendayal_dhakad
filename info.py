...
BOT_TOKEN = environ.get('BOT_TOKEN', "7498158728:AAGr6dN7flno4fHN4N-J6ohiT2Sd0f9VDas")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://envs.sh/4YF.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/4YF.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002435097024').split()] #Channel id for auto indexing ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sonudhakad1:4pGKChYIK1zpdPw3@cluster0.rbpgh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DEENDAYAL_VERIFY_EXPIRE = int(environ.get('DEENDAYAL_VERIFY_EXPIRE', '03')) # Add time in hours
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002116984433')) #Log channel id ( make sure bot is admin )
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/+d0lcBktNrZY0NDhl') # How to open tutorial link for verification

# Shortner 
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'shortxlinks.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '5174613668dc507cfe3b8b80b3c5a1b0f718278c')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/super4crazy786') # Tutorial video link for opening shortlink website 
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '852190589').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '-1002116984433').split()]
